...
public:
   ...
   *
   * @return true when an existing entrypoint was rebound and its compiled code must be invalidated.
   */
  FEX_DEFAULT_VISIBILITY virtual bool AddThunkTrampolineIRHandler(uintptr_t Entrypoint, uintptr_t GuestThunkEntrypoint) = 0;
