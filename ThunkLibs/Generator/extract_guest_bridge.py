...
def write_bridge(path: Path, callbacks, prefix: str):
    lines = [
        ...
        "struct FEXResidentBridgeCanUnpack;",
...
def write_accessors(path: Path, callbacks, prefix: str):
    ...
    lines += [
        ...
        "  static_assert(FEXResidentBridgeCanUnpack<Signature>::value,",
        "                \"resident bridge callback unpacker requested for unsupported PackedArguments arity\");",
        "  return FEXResidentBridgeUnpacker<Signature>::Get();",
        "}",
        "",
