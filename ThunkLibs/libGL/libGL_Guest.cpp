...
extern "C" int FEXGLBridgeXSync(Display*, Bool);
extern "C" XVisualInfo* FEXGLBridgeXGetVisualInfo(Display*, long, XVisualInfo*, int*);
extern "C" char* FEXGLBridgeXDisplayString(Display*);
...
static void OnInit() {
  ...
  fexfn_pack_GL_SetGuestXSync((uintptr_t)FEXGLBridgeXSync, FEXGLBridgeXSyncUnpacker());
  fexfn_pack_GL_SetGuestXGetVisualInfo((uintptr_t)FEXGLBridgeXGetVisualInfo, FEXGLBridgeXGetVisualInfoUnpacker());
  fexfn_pack_GL_SetGuestXDisplayString((uintptr_t)FEXGLBridgeXDisplayString, FEXGLBridgeXDisplayStringUnpacker());
}
